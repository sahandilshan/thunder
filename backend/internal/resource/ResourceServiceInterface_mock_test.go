...
func (_mock *ResourceServiceInterfaceMock) SetEntityOwnerLookup(l EntityOwnerLookup) {
	_mock.Called(l)
	return
}
...
func (_c *ResourceServiceInterfaceMock_SetEntityOwnerLookup_Call) Run(run func(l EntityOwnerLookup)) *ResourceServiceInterfaceMock_SetEntityOwnerLookup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 EntityOwnerLookup
		if args[0] != nil {
			arg0 = args[0].(EntityOwnerLookup)
		}
		run(
			arg0,
		)
...
func (_c *ResourceServiceInterfaceMock_SetEntityOwnerLookup_Call) RunAndReturn(run func(l EntityOwnerLookup)) *ResourceServiceInterfaceMock_SetEntityOwnerLookup_Call {
	_c.Run(run)
	return _c
}
